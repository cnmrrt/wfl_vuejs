...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="main" role="main"><h1>Proverbs</h1><div class="home-container words-container"><section class="section" id="word-container"><ul><!--[-->`);
      ssrRenderList(words.value, (item) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(item.preverb)}`);
            } else {
              return [
                createTextVNode(toDisplayString(item.preverb), 1)
              ];
            }
          }),
          _: 2
...
//# sourceMappingURL=index-DNlhZam3.mjs.map
