...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getRequestHost, getRequestProtocol, setHeader, getHeader, getQuery as getQuery$1, readBody, getRouterParam, getResponseStatus, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, decodePath, withLeadingSlash, withoutTrailingSlash, withoutProtocol, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/vue/index.mjs';
import devalue from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, isAbsolute } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/mac/Desktop/wfl_vuejs/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/mac/Desktop/wfl_vuejs/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mac/Desktop/wfl_vuejs","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mac/Desktop/wfl_vuejs/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mac/Desktop/wfl_vuejs/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mac/Desktop/wfl_vuejs/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mac/Desktop/wfl_vuejs/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/mac/Desktop/wfl_vuejs/public"
      ]
    },
    "http": {
      "domains": []
...
const _Np9nMXvX8d7AfLG_EkHPYFgxOdmn5l_KH0bV8owdelc = (function(nitro) {
...
const _49H15cZlRc4zcxOI_AcDktLjeBuk2xcZRvXZixz3_j0 = (nitroApp) => {
...
const plugins = [
  _Np9nMXvX8d7AfLG_EkHPYFgxOdmn5l_KH0bV8owdelc,
_49H15cZlRc4zcxOI_AcDktLjeBuk2xcZRvXZixz3_j0,
...
const _SblX8Q = eventHandler(async (e) => {
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file:///Users/mac/Desktop/wfl_vuejs/node_modules/fast-xml-parser/src/fxp.js');
...
const _R7wCpx = defineEventHandler(async (e) => {
...
const getServerEntry = () => import('file:///Users/mac/Desktop/wfl_vuejs/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/mac/Desktop/wfl_vuejs/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _y5Rh8f = eventHandler(async (event) => {
  ...
  return await import('file:///Users/mac/Desktop/wfl_vuejs/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _lazy_CscNuU = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: _SblX8Q, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/nuxt-content-urls.json', handler: _Zd7uC2, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _R7wCpx, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/_scripts/**', handler: _lazy_CscNuU, lazy: true, middleware: false, method: undefined },
